...
# ── Upload happens during exportArchive (destination=upload in plist) ────────
# No separate validate/upload step needed.

if $DRY_RUN; then
    echo ""
    echo "==> Dry run complete. Archives built but NOT uploaded."
